...
class AnomalyMapGenerator(nn.Module):
    ...
    @staticmethod
    def compute_distance(self, embedding: torch.Tensor, stats: list[torch.Tensor]) -> torch.Tensor:
    ...
    def compute_anomaly_map(
        ...
        """
        score_map = self.compute_distance(self=self,
            embedding=embedding,
